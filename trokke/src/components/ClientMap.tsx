...
const ClientMap = () => {
  ...
  useEffect(() => {
    const fetchClientData = async () => {
      ...
      const { data, error } = await supabase.rpc('get_client_truck_and_store_locations', {
  ...
  const getIconForMarker = (type: LocationMarker['type']) => {
    return type === 'truck' ? truckIcon : storeIcon;
  };
